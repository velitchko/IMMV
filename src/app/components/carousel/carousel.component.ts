import { Component, OnInit, Input, ViewChild, AfterViewInit, Inject, SimpleChanges, OnDestroy, ChangeDetectorRef, ElementRef } from '@angular/core';
...
export class CarouselComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('carouselComponent', { static: false }) carousel: ElementRef;
  @ViewChild('slideContainer', { static: false }) slideContainer: ElementRef;
  @ViewChild('prevArrow', { static: false }) previous: ElementRef;
  @ViewChild('nextArrow', { static: false }) next: ElementRef;
  @Input() source: Source;
  @Input() height: number;
  @Input() width: number;
  // @Input() height: number;
  ...
  createSlides(): void {
    ...
    this.source.identifiers.forEach((i: any) => {
      ...
      if(this.isPDF(safeUrl) && this.getDomain(safeUrl) === this.getDomain(environment.APP_URL)) {
        ...
        // TODO: Based on file extension set type as video or audio.
