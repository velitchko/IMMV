...
export class PeopleTimelineComponent implements AfterViewInit {
    @ViewChild('peopletimeline', { static: true }) timelineContainer: ElementRef;
    ...
    timelineItems: DataSet<any>;
    timelineGroups: DataSet<any>;
    ...
    createTimeline(peopleOrganizations?: Array<PersonOrganization>): void {
        ...
        this.timeline = new Timeline(this.timelineContainer.nativeElement, this.timelineItems, options);
