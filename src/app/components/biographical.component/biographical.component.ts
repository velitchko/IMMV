...
export class BiographicalComponent implements OnInit {
  // HTML 
  @ViewChild('timelineRadial', { static: true }) timelineRadial: ElementRef;
  @ViewChild('timelineChart', { static: true }) timelineChart: ElementRef;
  @ViewChild('brushHolder', { static: true }) brushContainer: ElementRef;
  @ViewChild('mapHolder', { static: true }) mapContainer: ElementRef;
  @ViewChild('tooltip', { static: true }) tooltip: ElementRef;
  @ViewChild('configInput', { static: true }) configInput: ElementRef;
  // display range
  ...
  handleClick(object: any): void {
    ...
    switch (object.objectType) {
      case 'Event':
        this.selectedObject = (this.db.getEventById(object.dateID) as Event & PersonOrganization & Location);
      ...
      case 'Person':
        ...
        this.selectedObject = (this.db.getPersonById(object.personID) as Event & PersonOrganization & Location);
        this.objectSelected = true;
        break;
      case 'Location':
        this.selectedObject = (this.db.getLocationById(object.personID) as Event & PersonOrganization & Location)
        this.objectSelected = true;
        break;
      case 'Source':
